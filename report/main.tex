...
\lstdefinestyle{PowerShell-editor}{
    language=PowerShell,
    backgroundcolor=\color{codebg},
    basicstyle=\ttfamily\small,
    keywordstyle=\color{codeblue}\bfseries,
    ...
    keepspaces=true,
    captionpos=b,
    % Extra PowerShell highlighting
    morekeywords={
        Get-ChildItem,Get-Content,Set-Content,
        Write-Host,Write-Output,ForEach-Object,
        Where-Object,Select-Object,Start-Process,
        Stop-Process,New-Item,Remove-Item,
        Copy-Item,Move-Item,Test-Path,
        Import-Module,Export-Csv,ConvertTo-Json,
        param,function,foreach,if,else,switch,
...
\lstdefinestyle{Bash-editor}{
    ...
    keepspaces=true,
    captionpos=b,
    % Extra Bash highlighting
    morekeywords={
        if,then,else,elif,fi,
        for,in,while,do,done,
        case,esac,select,
        function,return,
        break,continue,
        echo,read,exit,
        export,unset,
        cd,pwd,ls,grep,awk,sed,
        chmod,chown,
        mkdir,rmdir,
        touch,
        source
...
\url{https://github.com/spitfire233/Matlab-Eigen-benchmark}
}
